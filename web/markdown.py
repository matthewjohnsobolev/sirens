...
def render_index_markdown(site_url: str) -> str:
    ...
    body = (
        ...
        "## Використання даних та атрибуція (AI & Data Attribution)\n\n"
        "Дані дозволено використовувати для пошуку, відповідей на запити користувачів та агрегації. "
        f"При цитуванні або використанні даних сервісу посилання на **Sirens** ({site_url}) є обов'язковим."
    )
