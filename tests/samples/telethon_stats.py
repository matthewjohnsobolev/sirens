...
def full_channel(participants_count):
    ...
    return SimpleNamespace(
        full_chat=SimpleNamespace(participants_count=participants_count)
    )


# A slice of config.real_channels: distinct ids, plus the foreign source channel.
NETWORK_CHANNELS = {
...
# The shape config.test_channels has: every city pointing at one test channel.
SHARED_CHANNELS = {
